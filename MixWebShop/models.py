...
class Admin(models.Model):
    ...
    person_id = models.ForeignKey(to=Person.person_id, on_delete=models.CASCADE)  # Foreign Key


class User(models.Model):
    user_id = models.AutoField(primary_key=True)  # Primary key
    person_id = models.ForeignKey(to=Person.person_id, on_delete=models.CASCADE)  # Foreign Key
    address_id = models.ForeignKey(to=ShippingAddress.address_id, on_delete=models.CASCADE)  # Foreign Key
...
class Product(models.Model):
    ...
    category_id = models.ForeignKey(Category.category_id, on_delete=models.CASCADE)  # Foreign Key
    name = models.TextField(max_length=100, null=False)
